 ...
 * no shared marks, no react-router Link. Whatever threw might be one of those, and a
  ...
  render() {
    ...
    return (
      <div className="mx-auto flex max-w-3xl flex-col items-start px-6 py-24 md:px-10 md:py-32">
        <p className="eyebrow text-slate-400">Something went wrong</p>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <button
            ...
            className="bg-green-600 hover:bg-green-700 inline-flex items-center rounded-full px-6 py-3 font-semibold text-white transition-colors"
          >
            Reload this page
          </button>
          ...
          <a
            href="/"
            className="text-green-700 hover:bg-mint-100 inline-flex items-center rounded-full px-6 py-3 font-semibold transition-colors"
          >
            Go to the home page
          </a>
        </div>
        ...
        {import.meta.env.DEV && (
          <pre className="border-slate-200 text-slate-500 mt-12 w-full overflow-x-auto rounded-xl border border-dashed p-5 text-[14px] leading-relaxed">
