...
export const SITE = {
  ...
  intro:
    "Warehouse analytics for the five research centers and experiment stations of Cagayan Valley. " +
...
export const STATIONS = [
  ...
  },
  {
    ...
    embedUrl: "",
    blurb: "Warehouse stock movement and storage conditions for the Ilagan station.",
  },
  {
    slug: "cvrc",
    short: "CVRC",
    ...
    embedUrl: "",
    blurb: "Seed and input inventory for the regional research center at Ilagan.",
  },
  {
    slug: "scrc",
    short: "SCRC",
    ...
    embedUrl: "",
    blurb: "Warehouse stock movement and storage conditions for the SCRC station.",
  },
  {
    slug: "qes",
    short: "QES",
    ...
    embedUrl: "",
    blurb: "Warehouse stock movement and storage conditions for the Quirino station.",
  },
];
